    ...
    def leaves_list(self):
        ...
        def sub_func(root):
            if root is None:
                ...
                left = sub_func(root.left)
                right = sub_func(root.right)
                l = left+right+[root.data for i in range(1) if root.left is None and root.right is None]
                return l
            
        return sub_func(self.root)
